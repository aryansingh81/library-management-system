...
class maincode:
     ...
     def login(self):
         ...
         if self.ab!=None:
             ...
             self.cur()
               ...
               messagebox.showerror('Library System', 'ID and PASSWORD is not available')
             #---------------------------------------------------------
     def cur(self):
             ...
             self.photo9=PhotoImage(file="C:/Users/singh/OneDrive/Desktop/LMS/bb.png")
             self.canvas8.create_image(0,0,image=self.photo9,anchor=NW)

             # develop name--------------------
             
             self.develop=Label(self.fm3,text='Developed By - Aryan Arunima Aman Ashmita',bg='#fff',fg='blue',
    ...
    #-------------------------------------------SHOW BOOKS_------------------------------------------------
     ...
     def code(self):
         ...
         self.photo=PhotoImage(file="C:/Users/91902/Documents/PROJECT/LMS/images (17).png")
         ...
         self.photo1=PhotoImage(file="C:/Users/91902/Documents/PROJECT/LMS/dd.png")
     ...
     def chan_pas(self):
         ...
         if self.data!=None:
             ...
             self.er = Label(self.rog, text='ID is not present', bg='#fff', fg='red', font=("cursive", 8, 'bold'))
